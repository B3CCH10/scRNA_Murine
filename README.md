...
- We constructed a shared nearest neighbor <b>(SNN)</b> graph based on the top 9 principal components. We then applied:
<b>UMAP </b>algorithm to visualize the data in two dimensions .
<b> Leiden </b> algorithm for community detection on our SNN graph. 
